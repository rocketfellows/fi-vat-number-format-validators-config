...
namespace rocketfellows\FIVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\FIVatNumberFormatValidatorsConfig\FIVatNumberFormatValidatorsConfig;

class FIVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = FIVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = FIVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::FI(), $config->getCountry());
    }
